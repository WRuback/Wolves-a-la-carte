...
function findRecipeInfo(recipeID) {
  ...
  fetch(url)
      ...
      //     var receipeTitle = document.getElementById('h1');
      //     receipeTitle.textContent = data[i].title
      //     renderModal.append(receipeTitle)
      //   } 
    .then(function (response) {
      if (response.status === 401) {
        console.log("You failed!");
...
//    let card = $(`<div class="modal-background"></div>
//         <div class="modal-content">
//             <div class="box">
//                 <div class="columns is-mobile">
//                     <div class="column">${findRecipeInfo}</div>

//                     <div class="column">
//                         <h1>${recipe.title}</h1>
//                         <img src="${recipe.image}" alt="product">
//                         <div class="buttons are-medium">
//                             <button class="button">Recipe Instructions</button>
//                         </div>
//                     </div>
//                 </div>
// 			      </div>
